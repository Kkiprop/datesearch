...
DEFAULT_JSON = r"C:\Users\Admin\Downloads\Dashboard_data.gross_margin.json"
...
def create_table(cur):
    cur.execute("DROP TABLE IF EXISTS gross_margin;")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Import Gross Margin data into PostgreSQL"
    )
